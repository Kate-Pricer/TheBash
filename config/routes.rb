TheBash::Application.routes.draw do
  ...
  match '/event' => 'home#event', :as => :event,:as => :event
  match '/hotel' => 'home#hotel', :as => :hotel,:as => :hotel
  match '/contact_us' => 'home#contact_us', :as => :contact_us
  match '/about' => 'home#about', :as => :about,:as => :about
  match '/gifts' => 'home#gifts', :as => :gifts,:as => :gifts
